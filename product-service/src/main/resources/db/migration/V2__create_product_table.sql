...
INSERT INTO product(category_id, name, unit_price, description, quantity, created_time, updated_time)
VALUES (1, 'Pampers', 1000, 'Pampers Swaddlers Diapers Size 4, 150 count - Disposable Diapers', 37, current_timestamp,
       ...
       (2, 'Deodorant', 1000,
        ...
        current_timestamp),
       (3, 'The Hunger Games', 1000, 'The Hunger Games: Special Edition', 37, current_timestamp, current_timestamp),
